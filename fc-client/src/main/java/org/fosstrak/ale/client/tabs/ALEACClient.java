 ...
 * @author swieland
 */
public class ALEACClient extends AbstractTab {
	 ...
	 */
	public static final String CFG_ENDPOINT = "org.fosstrak.ale.client.aleac.endpoint";
	...
	// logger.
	private static final Logger s_log = Logger.getLogger(ALEACClient.class);
	 ...
	 */
	public ALEACClient(JFrame parent) throws SecurityException, NoSuchMethodException {
