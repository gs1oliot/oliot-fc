...
public class TestAdaptor extends BaseReader {
	...
	public void ADDACCESSSPECfromCCSpec(CCSpec ccspec, Hashtable<Integer, CCOpSpec> OpSpecTable) {
		try {
			throw new ImplementationException("TESTAdaptor ADD_ACCESSSPEC from CCSpec is not supported");
	...
	{
		try {
			throw new ImplementationException("TESTAdaptor DELETE_ACCESSSPEC from CCSpec is not supported");
		} catch (ImplementationException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
